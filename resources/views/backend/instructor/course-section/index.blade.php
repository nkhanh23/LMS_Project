...
@section('content')
    <div class="page-content">
        <!--breadcrumb-->
        @include('backend.section.breadcrumb', ['title' => 'Bài học', 'sub_title' => 'Tất cả bài học'])
        <!--end breadcrumb-->
        <div class="row">
            <div class="col-12 col-lg-12">
                <div style="display: flex; align-items:center; justify-content:space-between">
                    <h6 class="mb-0 text-uppercase">Quản lý bài học</h6>
                ...
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            ...
                            <div>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">Thêm bài
                                    học</button>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <div style="display: flex; alin-items: center; gap: 10">
                                    ...
                                    <div>
                                        ...
                                        <form id="delete-form-{{ $data->id }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
