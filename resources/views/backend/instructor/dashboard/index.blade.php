                            ...
                            @if ($card['trend'] !== null)
                                <div class="d-flex align-items-center" style="font-size: 0.78rem;">
                                    @if ($card['trend']['direction'] === 'up')
                                        <span class="badge bg-light text-success d-flex align-items-center px-2 py-1" style="border-radius: 8px;">
                                            <span class="material-symbols-outlined" style="font-size: 14px;">trending_up</span>
                                            <span class="ms-1">+{{ $card['trend']['percent'] }}%</span>
                                        </span>
                                    @else
                                        <span class="badge bg-light text-danger d-flex align-items-center px-2 py-1" style="border-radius: 8px;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                @if($course['status'] == 'Published')
                                                    <span class="badge bg-light text-success px-2 py-1 border border-success">Published</span>
                                                @else
                                                    <span class="badge bg-light text-warning px-2 py-1 border border-warning">{{ $course['status'] }}</span>
                                                @endif
                                            </td>
                                        </tr>
                                    @empty
                            ...
                            <div class="list-group list-group-flush" style="max-height: 400px; overflow-y: auto;">
                                @foreach ($recentActivities as $act)
                                    <div class="list-group-item border-0 px-0 py-2 d-flex align-items-start">
                                        <div class="d-flex align-items-center justify-content-center rounded-circle me-3 bg-light flex-shrink-0"
