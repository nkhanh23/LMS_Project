...
@section('content')
    <div class="page-content">
        ...
        @include('backend.section.breadcrumb', [
            'title' => 'Nhà tài trợ',
            'sub_title' => 'Cấu hình nhà tài trợ',
        ])

        <!--end breadcrumb-->
        <div style="display: flex; align-items:center; justify-content:space-between">
            <h6 class="mb-0 text-uppercase">Danh sách nhà tài trợ </h6>
            <a href="{{ route('admin.partner.create') }}" class="btn btn-primary">Thêm nhà tài trợ</a>
