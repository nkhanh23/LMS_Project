...
@section('content')
    <div class="page-content">
        ...
        @include('backend.section.breadcrumb', [
            'title' => 'Nhà tài trợ',
            'sub_title' => 'Cập nhật nhà tài trợ',
        ])
        <!--end breadcrumb-->
            ...
            <div class="card-body">
                ...
                <div class="card-body p-4">
                    ...
                    <div style="display: flex; align-items:center; justify-content:space-between">
                        <h5 class="mb-4">Cập nhật nhà tài trợ</h5>
                        <a href="{{ route('admin.partner.index') }}" class="btn btn-primary">Quay lại</a>

                    </div>

                    <form class="row g-3" method="post" action="{{ route('admin.partner.update', $partner->id) }}"
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-control" name="name" id="partner_name"
                                value="{{ $partner->name }}" placeholder="Nhập tên nhà tài trợ">
                        </div>
                        <div class="col-md-12">
