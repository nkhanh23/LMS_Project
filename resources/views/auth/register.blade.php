...
<head>
    ...
    <title>StackLearn - Đăng Ký Tài Khoản</title>
...
<body
    ...
    <!-- Main Register Card -->
    <div class="relative z-10 w-full max-w-[520px] p-4 max-h-[95vh] overflow-y-auto scrollbar-hide">
        <div class="border-4 border-black bg-cyber-dark/95 pixel-shadow">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="group">
                        <label
                            ...
                            <i class="fas fa-user text-cyber-cyan text-base"></i>
                            Tên người dùng
                        </label>
                        <div class="relative">
                            <input name="name" value="{{ old('name') }}"
                                class="w-full bg-black/50 border-2 border-slate-700 text-text-primary p-3 sm:p-4 font-bold text-base sm:text-lg focus:outline-none focus:border-brand focus:shadow-[0_0_10px_rgba(166,226,46,0.3)] placeholder-text-secondary/40 transition-all duration-150 rounded-none tracking-wider"
                                placeholder="Tên của bạn" spellcheck="false" type="text" required autofocus />
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>
                    </div>
                    ...
                    <div class="group mt-4">
                        ...
                        <div class="relative">
                            <input name="password"
                                class="w-full bg-black/50 border-2 border-slate-700 text-text-primary p-3 sm:p-4 font-bold text-base sm:text-lg focus:outline-none focus:border-brand focus:shadow-[0_0_10px_rgba(166,226,46,0.3)] placeholder-text-secondary/40 transition-all duration-150 rounded-none tracking-widest"
                    ...
                    <div class="mt-6 text-center">
                        <a class="text-text-secondary text-sm font-medium uppercase tracking-wide hover:text-brand transition-colors duration-150"
                            href="{{ route('login') }}">
                            // Bạn đã có tài khoản? <span class="underline decoration-dashed">Đăng nhập tại đây</span> //
                        </a>
                    </div>
                    ...
                    <button type="submit"
                        ...
                        <i class="fas fa-user-plus font-bold text-lg"></i>
                        [ ĐĂNG KÝ TÀI KHOẢN ]
                    </button>
                </form>
            ...
            <div
                ...
                <span class="flex items-center gap-2">
                    <span class="h-2 w-2 rounded-full bg-cyber-cyan animate-ping"></span>
