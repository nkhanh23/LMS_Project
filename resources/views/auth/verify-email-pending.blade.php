        ...
        <div class="border-4 border-black bg-cyber-dark/95 pixel-shadow">
            ...
            <div class="p-6 sm:p-8 flex flex-col gap-4 text-center bg-cyber-surface/30">
                <div class="text-text-primary text-base sm:text-lg font-bold tracking-wide leading-relaxed">
                    <p class="text-brand">// ĐĂNG KÝ BƯỚC ĐẦU THÀNH CÔNG //</p>
                    <p class="mt-4 text-text-primary">Chúng tôi đã gửi một liên kết xác nhận đăng ký tài khoản đến địa chỉ email của bạn.</p>
                    <p class="mt-2 text-text-secondary">Vui lòng kiểm tra hộp thư (bao gồm cả thư rác/spam) và click vào liên kết để kích hoạt tài khoản của bạn.</p>
                </div>
                ...
                <a href="{{ route('login') }}"
                    ...
                    <i class="fas fa-arrow-left font-bold text-lg"></i>
                    [ QUAY VỀ ĐĂNG NHẬP ]
                </a>
            </div>
